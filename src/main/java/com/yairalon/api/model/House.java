...
@MongoEntity(database = "cabastro", collection = "house")
public class House {
    ...
    public House( String name, String description_en, String description_pt, String description_es, String description_he, String image) {
