...
@MongoEntity(database = "cabastro", collection = "planet")
public class Planet {
    private String id;
    private String UUID;
    private String name;
    ...
    public Planet( String name, String description_en, String description_pt, String description_es, String description_he, String image) {
