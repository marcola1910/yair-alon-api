...
public class TransitsInterpretationsDTO {
    private String UUID;
    ...
    public TransitsInterpretationsDTO() {}

    public TransitsInterpretationsDTO( String UUID, String birthAstro, String transitAstro, String aspect, int house, String text, String text_en, String text_es, String text_he) {
        this.UUID = UUID;
