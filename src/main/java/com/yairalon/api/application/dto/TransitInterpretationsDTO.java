...
public class TransitInterpretationsDTO {
    ...
    public TransitInterpretationsDTO() {

    }

    public TransitInterpretationsDTO(String id, String UUID, String birthAstro, String transitAstro, String aspect, int house, String text, String text_en, String text_es, String text_he) {
